...
public interface IScanner {
    ...
    CodeErrorManager getCodeErrorManager();
    ...
    void setTabWidth(int var1);

    int getStartPosition();

    int getEndPosition();

    StabKeyword getKeyword();

    RestorePoint createRestorePoint();

    void restore(RestorePoint var1);

    void addError(ParseErrorId var1, int var2, String var3);

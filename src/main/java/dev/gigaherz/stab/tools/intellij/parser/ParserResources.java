package dev.gigaherz.stab.tools.intellij.parser;
/*
 ...
 */
import dev.gigaherz.stab.tools.intellij.compiler.ParseErrorId;
import dev.gigaherz.stab.tools.intellij.compiler.ResourceManager;
...
public class ParserResources
{
    ...
    static final ResourceManager getResourceManager() {
        if (resourceManager == null) {
            resourceManager = new ResourceManager(ParserResources.class, "messages");
        }
